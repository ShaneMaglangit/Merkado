...
public class CheckoutView extends JDialog {
     ...
     */
    public CheckoutView(Frame owner) throws HeadlessException {
        super(owner, true);
    ...
    public HintTextField getTxtAddress() {
        return txtAddress;
    }

    public HintTextField getTxtPhoneNumber() {
        return txtPhoneNumber;
    }

    public ButtonGroup getBgPaymentOption() {
    ...
    public HintTextField getTxtExpiration() {
        return txtExpiration;
    }

    public HintTextField getTxtCVV() {
        return txtCVV;
    }
    ...
    public RoundedButton getBtnConfirm() {
        return btnConfirm;
    }
}